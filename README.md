# airflow-etl-air-quality-pipeline
ETL pipeline project using Airflow, Docker, Pandas, and MySQL, including data cleaning, transformation, and orchestration.
...
* **Solution:** Recreate the connection with the correct credentials
